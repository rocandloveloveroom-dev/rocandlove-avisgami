...
<head>
  ...
  <style>
    body { margin: 0; padding: 0; font-family: Georgia, serif; background-color: #000000; }
    .container { max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #1a1a1a 0%, #000000 100%); }
    .header { background: linear-gradient(135deg, #B9A378 0%, #8B7355 100%); padding: 40px 20px; text-align: center; }
    .logo { font-family: 'Brittany Signature', cursive; font-size: 48px; color: #000000; margin: 0; }
    .content { padding: 40px 30px; color: #DCD1BC; }
    .prize-box { background: rgba(185, 163, 120, 0.1); border: 2px solid #B9A378; border-radius: 16px; padding: 30px; text-align: center; margin: 30px 0; }
    .emoji { font-size: 72px; margin-bottom: 20px; }
    .prize-title { font-size: 28px; color: #B9A378; margin: 15px 0; font-weight: bold; }
    .prize-description { font-size: 16px; color: #DCD1BC; margin-bottom: 20px; }
    .code-box { background: #000000; border: 2px solid #B9A378; border-radius: 12px; padding: 20px; margin: 25px 0; }
    .code-label { font-size: 14px; color: #B9A378; margin-bottom: 10px; }
    .code { font-family: 'Courier New', monospace; font-size: 32px; color: #B9A378; letter-spacing: 0.3em; font-weight: bold; }
    .validity { font-size: 14px; color: #8B7355; margin-top: 15px; font-style: italic; }
    .cta-button { display: inline-block; background: linear-gradient(135deg, #B9A378 0%, #8B7355 100%); color: #000000; padding: 18px 40px; text-decoration: none; border-radius: 12px; font-weight: bold; font-size: 18px; margin: 30px 0; }
    .footer { padding: 30px; text-align: center; color: #666666; font-size: 14px; border-top: 1px solid #333333; }
    .instructions { background: rgba(185, 163, 120, 0.05); border-left: 4px solid #B9A378; padding: 20px; margin: 25px 0; color: #DCD1BC; }
  </style>
</head>
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="font-size: 16px; line-height: 1.6;">
        Merci infiniment pour votre séjour au Roc & Love et pour votre avis !
      </p>
