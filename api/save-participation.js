...
export default async function handler(req, res) {
  ...
  try {
    const { sessionId, clientName, clientPhone, prize, code, channel } = req.body;
    ...
    const result = await sql`
      INSERT INTO participations (
        session_id, client_name, client_phone, prize_emoji, prize_title, 
        prize_description, promo_code, channel, review_clicked, scratched, 
        created_at
      ) VALUES (
        ${sessionId}, ${clientName}, ${clientPhone || ''}, ${prize.emoji}, 
